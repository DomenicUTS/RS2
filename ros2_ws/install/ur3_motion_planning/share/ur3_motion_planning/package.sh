...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/domenic/RS2/ros2_ws/install/ur3_motion_planning"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/ur3_motion_planning/hook/path.sh"
